		...
		<div class="VC-ROW">
			<div class="VC-SPAN">
				<div class="VC-WRAPPER">
					...
					<?php include 'composer-elements/hero.php'; ?>
		...
		<div class="VC-ROW">
			<div class="VC-SPAN">
				<div class="VC-WRAPPER">
					...
					<?php include 'composer-elements/products-three-items.php'; ?>
		...
		<div class="VC-ROW">
			<div class="VC-SPAN">
				<div class="VC-WRAPPER">
					...
					<?php include 'composer-elements/features.php'; ?>
